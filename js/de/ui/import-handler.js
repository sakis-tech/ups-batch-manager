...
class ImportHandlerDE {
    ...
    createFieldMapping(headers) {
        ...
        headers.forEach((header, index) => {
            ...
            // Spezielle Mappings für häufige Varianten (erweitert für alle UPS-Felder)
            if (!mapping[index]) {
                const specialMappings = {
                    ...
                    'warenbeschreibung': 'goodsDescription',
                    'description': 'goodsDescription',
                    'waren': 'goodsDescription',
                    'goods': 'goodsDescription',
                    'dokumente': 'documentsNoCommercialValue',
                    'documents': 'documentsNoCommercialValue',
                    'gnifc': 'gnifc',
                    'wert': 'declaredValue',
                    ...
                    'versand': 'service',
                    'shipping': 'service',
                    'zustellung': 'deliveryConfirmation',
                    'delivery': 'deliveryConfirmation',
                    'bestätigung': 'deliveryConfirmation',
                    'confirmation': 'deliveryConfirmation',
                    'freigabe': 'shipperRelease',
                    'release': 'shipperRelease',
                    'dokument': 'returnOfDocument',
                    'document': 'returnOfDocument',
                    'samstag': 'saturdayDelivery',
                    'saturday': 'saturdayDelivery',
                    'klima': 'carbonNeutral',
                    'carbon': 'carbonNeutral',
                    'neutral': 'carbonNeutral',
                    'großpaket': 'largePackage',
                    'large': 'largePackage',
                    'groß': 'largePackage',
                    'behandlung': 'additionalHandling',
                    'handling': 'additionalHandling',
                    'zusätzlich': 'additionalHandling',
                    'additional': 'additionalHandling',
                    
                    // Referenz-Informationen
                    'referenz': 'reference1',
                    'reference': 'reference1',
                    'ref': 'reference1',
                    'referenz1': 'reference1',
                    'reference1': 'reference1',
                    'referenz2': 'reference2',
                    'reference2': 'reference2',
                    'referenz3': 'reference3',
                    'reference3': 'reference3',
                    
                    // E-Mail-Benachrichtigungen
                    'benachrichtigung': 'emailNotification1Address',
                    'notification': 'emailNotification1Address',
                    'nachricht': 'emailMessage',
                    'message': 'emailMessage',
                    'fehler': 'emailFailureAddress',
                    'failure': 'emailFailureAddress',
                    
                    // Premium-Services
                    'premium': 'upsPremiumCare',
                    'care': 'upsPremiumCare',
                    'standort': 'locationId',
                    'location': 'locationId',
                    'access': 'locationId',
                    ...
                    // Lithium-Batterien
                    'lithium': 'lithiumIonAlone',
                    'batterie': 'lithiumIonAlone',
                    'battery': 'lithiumIonAlone',
                    'ion': 'lithiumIonAlone',
                    'metall': 'lithiumMetalAlone',
                    'metal': 'lithiumMetalAlone',
                    'gerät': 'lithiumIonInEquipment',
                    'equipment': 'lithiumIonInEquipment',
                    
                    // Spezial-Services
                    'wochenende': 'weekendCommercialDelivery',
                    'weekend': 'weekendCommercialDelivery',
                    'trockeneis': 'dryIceWeight',
                    'dry': 'dryIceWeight',
                    'ice': 'dryIceWeight',
                    'ware': 'merchandiseDescription',
                    'merchandise': 'merchandiseDescription',
                    'surepost': 'upsSurePostLimitedQuantity',
                    'sure': 'upsSurePostLimitedQuantity',
                    'post': 'upsSurePostLimitedQuantity',
                    
                    // ADL (Access Point) Services
                    'adl': 'adlCodValue',
                    'cod': 'adlCodValue',
                    'nachnahme': 'adlCodValue',
                    'direct': 'adlDirectDeliveryOnly',
                    'direkt': 'adlDirectDeliveryOnly',
                    'media': 'notificationMediaType',
                    'medien': 'notificationMediaType',
                    'sprache': 'notificationLanguage',
                    'language': 'notificationLanguage',
                    'auth': 'electronicPackageReleaseAuth',
                    'authentication': 'electronicPackageReleaseAuth',
                    'authentifizierung': 'electronicPackageReleaseAuth'
                };
